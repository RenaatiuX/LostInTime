...
public class PrehistoricBookFirstPage extends Page{
    ...
    public PrehistoricBookFirstPage() {
        ...
        this.addComponent(new ImageComponent(ResourceLocation.fromNamespaceAndPath(LostInTime.MODID, "textures/gui/book/lost_in_time_icon.png"), 461, 462).additionalScale(0.7f), Inset.ZERO, Dimension.fill());
