...
public class FoodInit {
    ...
    public static final FoodProperties RAW_PTERYGOTUS = new FoodProperties.Builder().nutrition(2)
            .saturationMod(0.2F).build();
    public static final FoodProperties COOKED_PTERYGOTUS = new FoodProperties.Builder().nutrition(5)
            .saturationMod(0.6F).build();
