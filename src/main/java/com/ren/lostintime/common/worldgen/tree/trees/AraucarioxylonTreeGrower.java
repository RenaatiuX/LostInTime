package com.ren.lostintime.common.worldgen.tree.trees;
...
public class AraucarioxylonTreeGrower extends AbstractTreeGrower {

    @Override
    protected @Nullable ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource pRandom, boolean pHasFlowers) {
        return LITConfiguredFeatures.ARAUCARIOXYLON_TREE_KEY;
    }
}
